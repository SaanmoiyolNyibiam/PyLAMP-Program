...
```
exa@ubuntu:~/0x02$ cat calculator_1.py
#!/usr/bin/python3
def add(a, b):
    """My addition function
...
- Your code should not be executed when imported
```
exa@ubuntu:~/0x02$ ./3-infinite_add.py
0
...
You should print only names that do __not__ start with `__`
Your code should not be executed when imported
Make sure you are running your code in Python3.8.x (`hidden_4.pyc` has been compiled with this version)
```
exa@ubuntu:~/0x02$ curl -Lso "hidden_4.pyc" "https://github.com/alx-tools/0x02.py/raw/master/hidden_4.pyc"
...
- Your code should not be executed when imported
```
exa@ubuntu:~/0x02$ cat variable_load_5.py
#!/usr/bin/python3
a = 98
"""Simple variable
"""
...
```
exa@ubuntu:~/0x02$ ./101-easy_print.py
#pythoniscool
exa@ubuntu:~/0x02$
```
Repo:
...
- You are not allowed to use:
    ...
    - any system calls
```
exa@ubuntu:~/0x02$ ./103-fast_alphabet.py
