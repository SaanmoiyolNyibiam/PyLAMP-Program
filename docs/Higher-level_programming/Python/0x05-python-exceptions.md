...
- You are not allowed to use `type()`
```
exa@ubuntu:~/0x05$ cat 100-main.py
#!/usr/bin/python3
...
- You have to use `try: / except:`
```
exa@ubuntu:~/0x05$ cat 101-main.py
#!/usr/bin/python3
